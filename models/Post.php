<?php 
  class Post {
    ...
    public function readSinglePost(){
      ...
      // Fetching associative single post data 
    ...
    public function update(){
      ...
      // Create query 
       $query = 'UPDATE ' . $this->table . ' SET title = :title, body = :body, author = :author, category_id = :category_id WHERE id = :id'; // or '?' (positional parameter)
